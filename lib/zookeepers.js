...
const path = require("path");
  ...
  //This will filter the zookeepers based on age, favoriteAnimal, and name
function filterByQuery(query, zookeepers){
  let filteredResults = zookeepers;
  if(query.age) {
    filteredResults = filteredResults.filter(
      //since our form data will be coming in as strings, and our JSON data is storing age as a number, we must convert the query string to a number to perform a comparison:
  ...
  return filteredResults;
              ...
              //-----findById() function------
  //HANDLE REQUESTS FOR A SPECIFIC ZOOKEEPER
